...
function Header() {
  ...
  return (
    <header className={`${style.header} ${isNight() ? style.dark : ''}`}>
      <Link className={style.logo} to="/">
        A.Merlinov
      </Link>
      <div className={`${style.menu} ${burgerClick ? style.open : ''}`}>
        <nav className={`${style.menu_list}`}>
          <Link onClick={linkClick} to="/" className={style.menu_link}>
            Home
          </Link>
          <Link onClick={linkClick} to="/about" className={style.menu_link}>
            About
          </Link>
          <Link onClick={linkClick} to="/stack" className={style.menu_link}>
            Tech Stack
          </Link>
          <Link onClick={linkClick} to="/projects" className={style.menu_link}>
            Projects
          </Link>
          <Link onClick={linkClick} to="/contact" className={style.menu_link}>
            Contact
          </Link>
      ...
      <div className={style.burger_container} onClick={handleClick}>
        <div
          className={`${style.hambergerIcon} ${
            burgerClick ? style.burger_open : ''
          }`}></div>
      </div>
    </header>
  );
